...
try:
    ...
    print("Step 2: _kill_old_instances_async...", flush=True)
    main_mod._kill_old_instances_async()
    ...
    print("Step 5a: Creating QPixmap for splash...", flush=True)
    from PyQt6.QtGui import QColor, QPixmap
    pixmap = QPixmap(520, 360)
    pixmap.fill(QColor("#0D0D0D"))
    print("  QPixmap created", flush=True)

    print("Step 5b: Creating SplashScreen instance...", flush=True)
