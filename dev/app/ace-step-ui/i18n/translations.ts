...
export const translations = {
  en: {
    ...
    customizedByYunji: 'Customized & integrated by Yunji Music Studio',
    yunjiStudio: 'Yunji Music Studio',
    yunjiOfficial: 'Yunji Official',
    follow: 'Follow',
    done: 'Done',
    light: 'Light',
    dark: 'Dark',
    ...
    noLoraFound: 'No LoRA adapters found',
    showFinalOnly: 'Show final only',
    ...
    loraLoad: 'Load',
    loraUnload: 'Unload',
    loraUnloadHint: 'Unload to free VRAM',
    loraDisabled: 'Disabled',
    loraScale: 'LoRA Scale',
    loraScaleDescription: 'Adjust the influence strength of the LoRA model',
    loraHintsTitle: 'Training Hints',

    // CreatePanel - Presets
    presets: 'Presets',
    savePreset: 'Save Preset',
    presetName: 'Preset Name',
    presetNamePlaceholder: 'e.g. My Cover Song Settings',
    presetDescription: 'Description',
    presetDescriptionPlaceholder: 'Describe what this preset is for...',
    presetCategory: 'Category',
    noPresets: 'No presets yet. Save your current settings as a preset!',
    ...
    presetHint: 'Only saves technical params, won\'t override lyrics/style/LoRA',

    // CreatePanel - Projects
    projects: 'Projects',
    newProject: 'New Project',
    projectName: 'Project Name',
    projectNamePlaceholder: 'e.g. My Song Project',
    projectHint: 'Saves all settings including lyrics, style, LoRA, etc.',
    projectSaveHint: 'Project saves ALL settings (lyrics, style, LoRA path, etc.) and supports auto-save & rollback.',
    saveProject: 'Save Project',
    active: 'Active',
    history: 'History',
    snapshotHint: 'Click a snapshot to restore settings to that point in time',
    noSnapshots: 'No snapshots yet. Auto-saves will appear here.',
    autoSave: 'Auto Save',
    manualSave: 'Manual Save',
    noProjects: 'No projects yet. Create a project to save all settings!',
    create: 'Create',
    close: 'Close',
    ...
    tagAppend: 'append',
    tagReplace: 'replace',
    autoInsertTrigger: 'Auto-active',
    effectiveStyle: 'Effective style',
    modelVariant: 'Model',
    fastModel: 'Quick',
    xlVariantHint: 'High quality · 18.8GB weights required',
    xlVariantWarning: 'The XL (4B) base requires downloading acestep-v15-xl-turbo weights (~18.8GB) in Model Manager first; >=16GB VRAM recommended. LoRAs trained on 1.5B cannot be reused on XL - retraining is required.',
    ...
    thinkingCotHint: 'Lets the lyric model reason about structure and metadata. Slightly slower.',
    useAdgHint: 'Adaptive Dual Guidance: dynamically adjusts CFG for quality. Base model only; slower.',
    allowLmBatchHint: 'Allow the LM to run in larger batches for speed (more VRAM).',
    useCotMetasHint: 'Let the LM reason about metadata like BPM, key, duration.',
    useCotCaptionHint: 'Let the LM reason about the caption/style text.',
    useCotLanguageHint: 'Let the LM reason about language selection.',
    autogenHint: 'Auto-generate missing fields when possible.',
    constrainedDecodingDebugHint: 'Include debug info for constrained decoding.',
    formatCaptionHint: 'Use the formatted caption produced by the AI formatter.',
    getScoresHint: 'Return scorer outputs for diagnostics.',
    getLrcHint: 'Return synced lyric (LRC) output when available.',
    ...
    lmModel06BDesc: '⚡ 最快速度，适合快速创作尝试。在较低配置硬件上也能流畅运行，适合简单的音乐风格探索。',
    lmModel17BDesc: '🎵 推荐之选，速度与质量平衡。适合大多数音乐创作场景，能理解复杂的风格描述，生成有创意的音乐。',
    lmModel4BDesc: '🌟 最高质量，适合专业创作。对音乐细节把控更佳，能生成更丰富的和声与节奏变化，适合追求高品质的用户。',
    ...
    quickTrain: 'One-Click Train',
    quickEnv: 'Environment',
    quickVram: 'VRAM',
    quickTierFull: 'Full',
    quickTierFp8: 'FP8',
    quickTierLow: 'Low',
    quickTierUnknown: 'Unknown',
    quickRecommendedVariant: 'Recommended base',
    quickNoVariant: 'None',
    quickDownloadedVariants: 'Downloaded',
    quickLowVramHint: 'VRAM is low. Download a base model or pick a smaller quality preset.',
    quickBasic: 'Basic',
    audioFolder: 'Audio folder',
    audioFolderHint: 'path',
    loraName: 'LoRA name',
    styleTag: 'Style tag',
    quality: 'Quality',
    qualityFast: 'Fast',
    ...
    qualityFastDesc: 'fastest',
    qualityBalancedDesc: 'balanced',
    qualityQualityDesc: 'best',
    captionTemplate: 'Caption template',
    captionPreview: 'Preview',
    advanced: 'Advanced',
    startQuickTrain: 'Start Training',
    quickCancel: 'Cancel',
    quickStageScanning: 'Scanning',
    quickStageLabeling: 'Generating captions',
    quickStageSaving: 'Saving dataset',
    quickStagePreprocessing: 'Preprocessing',
    quickStageTraining: 'Training',
    quickStageExporting: 'Exporting',
    quickStageRegistered: 'Completed',
    quickStageFailed: 'Failed',
    loading: 'Loading...',
    none: 'None',
    loraRank: 'LoRA Rank',
  ...
  zh: {
    ...
    customizedByYunji: '由 云集智能音乐创意台 定制与集成',
    yunjiStudio: '云集智能音乐创意台',
    yunjiOfficial: '云集官网',
    follow: '关注',
    done: '完成',
    light: '浅色',
    ...
    selectLora: '选择 LoRA',
    customPath: '自定义路径',
    noLoraFound: '未发现 LoRA 适配器',
    showFinalOnly: '仅显示训练完成的',
    showAllPaths: '显示全部',
    browseFiles: '浏览文件',
    loraLoaded: 'LoRA 已加载',
    ...
    savePreset: '保存预设',
    presetName: '预设名称',
    presetNamePlaceholder: '例如：我的翻唱设置',
    presetDescription: '描述',
    presetDescriptionPlaceholder: '描述此预设的用途...',
    presetCategory: '分类',
    noPresets: '暂无预设。将当前设置保存为预设吧！',
    customPresets: '我的预设',
    longAudio: '长音频',
    presetSaved: '预设保存成功',
    presetDeleted: '预设已删除',
    ...
    presetHint: '仅保存技术参数，不会覆盖歌词/风格/LoRA',

    // CreatePanel - Projects
    projects: '项目',
    newProject: '新建项目',
    projectName: '项目名称',
    projectNamePlaceholder: '例如：我的歌曲项目',
    projectHint: '保存全部设置，包括歌词、风格、LoRA等',
    projectSaveHint: '项目保存全部设置（歌词、风格、LoRA路径等），支持自动保存和回滚。',
    saveProject: '保存项目',
    active: '活跃',
    history: '历史',
    snapshotHint: '点击快照可将设置恢复到该时间点',
    noSnapshots: '暂无快照。自动保存的记录会显示在这里。',
    autoSave: '自动保存',
    manualSave: '手动保存',
    noProjects: '暂无项目。创建一个项目来保存全部设置吧！',
    create: '创建',
    close: '关闭',
    triggerWordLabel: '触发词',
    tagPrepend: '前置',
    tagAppend: '后置',
    tagReplace: '替换',
    autoInsertTrigger: '已自动生效',
    effectiveStyle: '实际风格',
    modelVariant: '模型',
    fastModel: '快速',
    xlVariantHint: '高质量·需18.8GB权重',
    xlVariantWarning: 'XL(4B) 底座需先在「模型管理」下载 acestep-v15-xl-turbo 权重(约18.8GB)；显存建议 ≥16GB。1.5B 上训练的 LoRA 不能复用到 XL，需重新训练。',
    fineTuned: '微调',
    baseModel: '基础',
    datasetName: '数据集',
    ...
    thinkingCotHint: '让歌词模型推理结构和元数据，稍慢。',
    useAdgHint: '自适应双重引导：动态调整 CFG 以提升质量。仅基础模型可用；较慢。',
    allowLmBatchHint: '允许 LM 以更大批次运行以提速（占用更多显存）。',
    useCotMetasHint: '让 LM 推理元数据，如 BPM、调性、时长等。',
    useCotCaptionHint: '让 LM 推理描述/风格文本。',
    useCotLanguageHint: '让 LM 推理语言选择。',
    autogenHint: '自动生成缺失的字段。',
    constrainedDecodingDebugHint: '包含约束解码的调试信息。',
    formatCaptionHint: '使用 AI 格式化器生成的格式化描述。',
    getScoresHint: '返回评分器输出，用于诊断。',
    getLrcHint: '返回同步歌词（LRC）输出。',
    mp3Smaller: 'MP3（较小）',
    ...
    quickTierLow: '不足',
    quickTierUnknown: '未知',
    quickRecommendedVariant: '推荐基底',
    quickNoVariant: '无',
    quickDownloadedVariants: '已下载',
    quickLowVramHint: '显存不足，请下载基底模型或选择更低的质量档。',
    quickBasic: '基础设置',
    audioFolder: '音频文件夹',
    audioFolderHint: '路径',
    loraName: 'LoRA 名称',
    ...
    qualityQuality: '质',
    qualityFastDesc: '最快',
    qualityBalancedDesc: '均衡',
    qualityQualityDesc: '最佳',
    captionTemplate: '描述模板',
    captionPreview: '预览',
    advanced: '高级',
    startQuickTrain: '开始训练',
    quickCancel: '取消',
    quickStageScanning: '扫描中',
    quickStageLabeling: '生成描述中',
    quickStageSaving: '保存数据集中',
    quickStagePreprocessing: '预处理中',
    quickStageTraining: '训练中',
    quickStageExporting: '导出中',
    quickStageRegistered: '已完成',
    quickStageFailed: '失败',
    loading: '加载中...',
    none: '无',
    loraRank: 'LoRA Rank',
  ...
  ja: {
    ...
    selectLora: 'LoRA を選択',
    customPath: 'カスタムパス',
    noLoraFound: 'LoRA アダプターが見つかりません',
    showFinalOnly: '最終版のみ表示',
    showAllPaths: 'すべて表示',
    browseFiles: 'ファイルを参照',
    ...
    loraLoad: '読み込む',
    loraUnload: 'アンロード',
    loraUnloadHint: 'VRAMを解放するためにアンロード',
    loraDisabled: '無効',
    loraScale: 'LoRA スケール',
    loraScaleDescription: 'LoRA モデルの影響強度を調整',
    loraHintsTitle: 'トレーニングヒント',

    // CreatePanel - Presets
    presets: 'プリセット',
    savePreset: 'プリセット保存',
    presetName: 'プリセット名',
    presetNamePlaceholder: '例：マイカバーソング設定',
    presetDescription: '説明',
    presetDescriptionPlaceholder: 'このプリセットの用途を説明...',
    presetCategory: 'カテゴリ',
    noPresets: 'プリセットがありません。現在の設定をプリセットとして保存しましょう！',
    customPresets: 'マイプリセット',
    longAudio: 'ロングオーディオ',
    presetSaved: 'プリセットを保存しました',
    presetDeleted: 'プリセットを削除しました',
    presetLoadFailed: 'プリセットの読み込みに失敗しました',
    presetSaveFailed: 'プリセットの保存に失敗しました',
    presetHint: '技術パラメータのみ保存、歌詞/スタイル/LoRAは上書きしません',

    // CreatePanel - Projects
    projects: 'プロジェクト',
    newProject: '新規プロジェクト',
    projectName: 'プロジェクト名',
    projectNamePlaceholder: '例：マイソングプロジェクト',
    projectHint: '歌詞、スタイル、LoRAなど全設定を保存',
    projectSaveHint: 'プロジェクトは全設定（歌詞、スタイル、LoRAパスなど）を保存し、自動保存とロールバックをサポートします。',
    saveProject: 'プロジェクト保存',
    active: 'アクティブ',
    history: '履歴',
    snapshotHint: 'スナップショットをクリックしてその時点の設定に復元',
    noSnapshots: 'スナップショットがありません。自動保存がここに表示されます。',
    autoSave: '自動保存',
    manualSave: '手動保存',
    noProjects: 'プロジェクトがありません。全設定を保存するプロジェクトを作成しましょう！',
    create: '作成',
    close: '閉じる',
    triggerWordLabel: 'トリガーワード',
    tagPrepend: '先頭',
    tagAppend: '末尾',
    tagReplace: '置換',
    autoInsertTrigger: '自動有効',
    effectiveStyle: '有効スタイル',
    modelVariant: 'モデル',
    fastModel: '高速',
    xlVariantHint: '高品質・18.8GBの重みが必要',
    xlVariantWarning: 'XL(4B)ベースはモデル管理で acestep-v15-xl-turbo の重み(約18.8GB)を先にダウンロードしてください。VRAM 16GB以上推奨。1.5Bで学習したLoRAはXLでは再利用できず、再学習が必要です。',
    fineTuned: '微調整',
    baseModel: 'ベース',
    datasetName: 'データセット',
    ...
    thinkingCot: '思考（CoT）',
    thinkingCotHint: '歌詞モデルに構造とメタデータを推論させます。少し遅くなります。',
    useAdgHint: '適応型デュアルガイダンス：CFGを動的に調整して品質を向上。ベースモデルのみ対応；遅い。',
    allowLmBatchHint: 'LMをより大きなバッチで実行して高速化（VRAM使用量増）。',
    useCotMetasHint: 'LMにBPM、キー、再生時間などのメタデータを推論させます。',
    useCotCaptionHint: 'LMにキャプション/スタイルテキストを推論させます。',
    useCotLanguageHint: 'LMに言語選択を推論させます。',
    autogenHint: '欠落フィールドを自動生成します。',
    constrainedDecodingDebugHint: '制約付きデコーディングのデバッグ情報を含めます。',
    formatCaptionHint: 'AIフォーマッタが生成したフォーマット済みキャプションを使用します。',
    getScoresHint: '診断用のスコアラー出力を返します。',
    getLrcHint: '同期歌詞（LRC）出力を返します。',
    mp3Smaller: 'MP3（小さい）',
  ...
  ko: {
    ...
    noLoraFound: 'LoRA 어댑터를 찾을 수 없습니다',
    showFinalOnly: '최종 버전만 표시',
    showAllPaths: '모두 표시',
    browseFiles: '파일 찾아보기',
    loraLoaded: 'LoRA 로드됨',
    ...
    loraLoad: '로드',
    loraUnload: '언로드',
    loraUnloadHint: 'VRAM 해제를 위해 언로드',
    loraDisabled: '비활성화',
    loraScale: 'LoRA 강도',
    loraScaleDescription: 'LoRA 모델의 영향 강도 조절',
    loraHintsTitle: '트레이닝 힌트',

    // CreatePanel - Presets
    presets: '프리셋',
    savePreset: '프리셋 저장',
    presetName: '프리셋 이름',
    presetNamePlaceholder: '예: 내 커버송 설정',
    presetDescription: '설명',
    presetDescriptionPlaceholder: '이 프리셋의 용도를 설명...',
    presetCategory: '카테고리',
    noPresets: '프리셋이 없습니다. 현재 설정을 프리셋으로 저장하세요!',
    customPresets: '내 프리셋',
    longAudio: '롱 오디오',
    ...
    presetHint: '기술 매개변수만 저장, 가사/스타일/LoRA는 덮어쓰지 않음',

    // CreatePanel - Projects
    projects: '프로젝트',
    newProject: '새 프로젝트',
    projectName: '프로젝트 이름',
    projectNamePlaceholder: '예: 내 노래 프로젝트',
    projectHint: '가사, 스타일, LoRA 등 모든 설정 저장',
    projectSaveHint: '프로젝트는 모든 설정(가사, 스타일, LoRA 경로 등)을 저장하며 자동 저장과 롤백을 지원합니다.',
    saveProject: '프로젝트 저장',
    active: '활성',
    history: '기록',
    snapshotHint: '스냅샷을 클릭하여 해당 시점의 설정으로 복원',
    noSnapshots: '스냅샷이 없습니다. 자동 저장이 여기에 표시됩니다.',
    autoSave: '자동 저장',
    manualSave: '수동 저장',
    noProjects: '프로젝트가 없습니다. 모든 설정을 저장할 프로젝트를 만드세요!',
    create: '만들기',
    close: '닫기',
    triggerWordLabel: '트리거 워드',
    autoInsertTrigger: '자동 활성화',
    effectiveStyle: '유효 스타일',
    modelVariant: '모델',
    fastModel: '빠른',
    xlVariantHint: '고품질 · 18.8GB 가중치 필요',
    xlVariantWarning: 'XL(4B) 베이스는 모델 관리에서 acestep-v15-xl-turbo 가중치(약 18.8GB)를 먼저 다운로드해야 합니다. VRAM 16GB 이상 권장. 1.5B에서 학습한 LoRA는 XL에서 재사용할 수 없으며 재학습이 필요합니다.',
    fineTuned: '미세조정',
    baseModel: '기초',
    datasetName: '데이터셋',
    ...
    thinkingCot: '생각 (CoT)',
    thinkingCotHint: '가사 모델이 구조와 메타데이터를 추론합니다. 약간 느립니다.',
    useAdgHint: '적응형 듀얼 가이던스: CFG를 동적으로 조정하여 품질 향상. 베이스 모델만 해당; 느림.',
    allowLmBatchHint: 'LM을 더 큰 배치로 실행하여 속도 향상 (VRAM 사용량 증가).',
    useCotMetasHint: 'LM이 BPM, 키, 길이 등 메타데이터를 추론합니다.',
    useCotCaptionHint: 'LM이 캡션/스타일 텍스트를 추론합니다.',
    useCotLanguageHint: 'LM이 언어 선택을 추론합니다.',
    autogenHint: '누락된 필드를 자동 생성합니다.',
    constrainedDecodingDebugHint: '제약 디코딩 디버그 정보를 포함합니다.',
    formatCaptionHint: 'AI 포매터가 생성한 포맷된 캡션을 사용합니다.',
    getScoresHint: '진단용 스코어러 출력을 반환합니다.',
    getLrcHint: '동기화된 가사(LRC) 출력을 반환합니다.',
    mp3Smaller: 'MP3 (작음)',
