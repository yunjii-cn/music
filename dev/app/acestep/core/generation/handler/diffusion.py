...
class DiffusionMixin:
    ...
    def _mlx_run_diffusion(
        ...
        Args:
            ...
            cover_noise_strength: Cover noise strength (0-1). Higher values mean closer to the original source audio.
        ...
        # Convert src_latents to numpy if present
        src_latents_np = src_latents.detach().cpu().float().numpy() if src_latents is not None else None
