...
if ($env:UV_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrls = @("https://releases.astral.sh/github/uv/releases/download/0.10.8", "https://ghfast.top/https://github.com/astral-sh/uv/releases/download/0.10.8")
}
