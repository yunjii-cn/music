                    ...
                    <div className="space-y-4">
                        ...
                        <div className="pl-7 space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
                            ...
                            <p className="text-xs mt-1">
                                <span className="text-zinc-500 dark:text-zinc-400">{t('customizedByYunji')}</span>
                                {' · '}
                                <a
                                    href="https://music.yunjii.cn"
                                    target="_blank"
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg text-sm font-medium hover:from-indigo-600 hover:to-purple-700 transition-colors"
                                        >
                                            <Globe size={16} />
                                            {t('yunjiOfficial')}
                                        </a>
